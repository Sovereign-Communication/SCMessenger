...
The function 'encrypt_xchacha20' is defined in 'core\src\dspy\signatures.rs' but is NEVER called anywhere in the repository. Your job is to fully integrate it into the overarching application loop. It may need to be wired into 1, 2, or 3+ different locations.

You MUST follow this strict analytical loop. Do not skip phases.

PHASE 1: CONTEXT GATHERING (Search & Ponder)
1. Open 'core\src\dspy\signatures.rs' and read the implementation of 'encrypt_xchacha20'. Understand its parameters, return type, and exact purpose.
...
3. Identify EVERY valid location in the codebase where 'encrypt_xchacha20' MUST be invoked to work fully. 
...
Reason: FALSE_POSITIVE:FALSE_POSITIVE:GOLDEN_STRING_LITERAL
Date: 2026-05-05T04:13:32Z
