...
Please add the following flat variants to `enum IronCoreError` inside `core/src/api.udl` immediately after `"CorruptionDetected",`:
```idl
    "DialSelf",
    "NoAddresses",
    "ConnectionLimit",
