...
2. **WiFi/identity WP1â€“5** from the implementation plan matrix (no guesswork).
3. **Then 0.4.0 tag** checklist + WP5 3-node proof + operator phone session.

**DONE = mechanical gates + harness JEV canonical pack `is_passing`** (plan Â§3).
`UNVERIFIED-JEV` / unkeyed fallback is **not** DONE â€” Freebuff PRs that claim
...
- One ticket per paste. Premise-check first; wrong premise â†’ inbox note.
...
## DISPATCHABLE â€” P0 WiFi/identity first (2026-09-21)
...
WP5 live 3-node proof is **not** a freebuff paste â€” evidence lands on
`HANDOFF/todo/P0_SCMESSENGER_WIFI_DELIVERY_IDENTITY_TRANSPORT_CANONICAL_2026-09-21.md`.

## DISPATCHABLE â€” parallel Wave-1 / mesh reliability
...
CO-B-001 dual-drain is **already merged** (#339) â€” do not paste that ticket as impl.
...
| Ticket | Why |
|---|---|
| T1/T2/T4 impl, T5â€“T12/T14 | CODE ON MAIN / MERGED |
