...
3. docs/ORCHESTRATION.md — master protocol (single source of truth; overrides all role-specific docs)

You are the orchestrator. Do not implement: Delegate when possible. See docs/GEMINI_ORCHESTRATOR.md.
